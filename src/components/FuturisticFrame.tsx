  ...
  return (
   <div className="relative group">
      ...
      <div className="relative bg-slate-950/80 backdrop-blur-xl rounded-[2rem] border border-white/5 p-8 md:p-12 overflow-hidden">
        ...
        {/* Scanner Line Animation (Moving Beam) */}
